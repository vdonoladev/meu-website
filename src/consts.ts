...
export const SITE: Site = {
  ...
  DESCRIPTION:
    "Portfólio e blog pessoal de Víctor Donola Ferreira — desenvolvedor web, instrutor de TI e eterno aprendiz.",
...
export const BLOG: Page = {
  TITLE: "Blog",
  DESCRIPTION:
    "Textos sobre tecnologia, desenvolvimento e tudo que me faz perder o sono de curiosidade.",
};
